...
Reuses core.config_policy._bool_env so default-ON and default-OFF flags share one parser.
Relocated from agents/task/surface_config.py (S3, 2026-08-29) — it read only config_policy
names, and eleven core/surfaces modules imported it upward.
"""
import os
