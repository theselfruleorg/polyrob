...
(The agents-tier re-export shims were retired 2026-08-28/29 — every importer and
monkeypatch target now names ``core.security.*`` directly.)
"""
import subprocess
import sys
...
def test_encryption_store_is_pure():
    _assert_pure("core.security.encryption")
