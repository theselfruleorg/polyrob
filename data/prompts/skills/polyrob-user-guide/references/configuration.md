...
- CHAT_SINGLE_FINAL — default: **ON** — One committed reply per turn (communication contract C1). `send_message` is the speech verb and claims the turn; `done`…
...
- BROWSER_CDP_URL — default: unset — Operator-configured Chrome DevTools Protocol endpoint for a browser kept OUTSIDE the agent process (hardened custody de…
- BROWSER_WSS_URL — default: unset — Operator-configured Playwright WebSocket endpoint for a remote browser service; unset = launch the bundled Chromium.
