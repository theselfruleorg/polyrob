...
Core-tier-free helper (stdlib only). Relocated from agents/task/agent/core/ to the LLM
layer in S5 (2026-08-29): modules/llm/messages, modules/credits/usage_tracker and
modules/memory/task/reflection_service all imported it upward.
"""
